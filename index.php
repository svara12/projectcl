...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" carousel-control-width:15%;>
  ...
  <div class="carousel-inner">
    ...
    <span class="w3-text-white" style="font-size:60px">welcome to online techinal forum</span>
  </div>
    <h5>welcome to online techinal forum</h5>
    <p>where you can ask,share and help others</p>
  </div>
    </div>
